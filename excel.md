...
<a title="実験データの例" href="http://science.shinshu-u.ac.jp/~tiiyama/?page_id=5550">実験データの例は別ページ</a>にあります。最初は1回目の実験結果だけを入力してください。
<h2>7. 参照を含んだコピー</h2>
<ul>
...
<ul type="circle">
 	<li>傾き(a)、切片(b)がわかれば、横軸(t)の値を使って、データ列の隣に、直線上の値を計算することが出来る <a title="エクセル-参考1" href="http://science.shinshu-u.ac.jp/~tiiyama/?page_id=5559">参考</a></li>
</ul>
<ul type="circle">
